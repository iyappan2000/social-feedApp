...
export default function Post({ post }) {
  ...
  return (
    <div className="post">
      <div title="Card title" bordered={false} className="postWrapper">
        ...
        <div className="postBottom">
          <div className="postBottomLeft">
            <FavoriteBorderIcon
              ...
              onClick={likeHandler}
            />
            <span className="postLikeCounter" style={{ paddingRight: "20px" }}>
              {like}
            </span>
            <ChatBubbleOutlineIcon className="likeIcon" />
            <span className="postLikeCounter">{comments.length}</span>
          </div>
        </div>
